...
دستورات زیر را به پردازنده خود اضافه کنید :
...
توصیه میشود در این مرحله ساختار پردازنده خود را برای حالت خط لوله آماده کنید. (به این صورت که خط لوله را بسازید اما صرفا ۱ دستور در هر لحظه درون آن باشد)

با دستور زیر پردازنده خود را آزمایش کنید :
